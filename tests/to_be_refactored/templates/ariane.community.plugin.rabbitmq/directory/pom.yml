...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/xsd/maven-4.0.0.xsd">
    ...
    <name>Ariane Community Plugin For RabbitMQ - Directory</name>
    ...
    <dependencies>
        ...
        <dependency>
            ...
            <version>${version.net.echinopsii.ariane.community.core.directory}</version>
            <scope>provided</scope>
        </dependency>
        <dependency>
            <groupId>net.echinopsii.ariane.community.core.directory</groupId>
            <artifactId>net.echinopsii.ariane.community.core.directory.wat</artifactId>
            <version>${version.net.echinopsii.ariane.community.core.directory}</version>
            <scope>provided</scope>
        </dependency>
    </dependencies>
        ...
        <plugins>
            ...
            <plugin>
                ...
                <configuration>
                    <instructions>
                        <Export-Package>
                            net.echinopsii.ariane.community.plugin.rabbitmq.directory;version=${project.version},
                            net.echinopsii.ariane.community.plugin.rabbitmq.directory.model;version=${project.version},
                            net.echinopsii.ariane.community.plugin.rabbitmq.directory.controller.rabbitmqcluster;version=${project.version},
                            net.echinopsii.ariane.community.plugin.rabbitmq.directory.controller.rabbitmqnode;version=${project.version},
                            net.echinopsii.ariane.community.plugin.rabbitmq.directory.rest;version=${project.version}
                        </Export-Package>
                        <Import-Package>
                            ...
                            net.echinopsii.ariane.community.core.directory.wat.controller;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.wat.controller.organisational.application;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.wat.controller.organisational.company;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.wat.controller.organisational.environment;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.wat.controller.organisational.team;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.wat.controller.technical.network.datacenter;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.wat.controller.technical.network.subnet;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.wat.controller.technical.network.routingArea;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.wat.controller.technical.system.OSInstance;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.wat.controller.technical.system.OSType;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.wat.rest.organisational;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.wat.rest.technical.system;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.base.model;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.base.model.organisational;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.base.model.technical.network;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.base.model.technical.system;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
                            net.echinopsii.ariane.community.core.directory.base.persistence;version="[${version.net.echinopsii.ariane.community.core.directory.min},${version.net.echinopsii.ariane.community.core.directory.max})",
